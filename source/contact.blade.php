...
description: Thank you for your interest in Modern Sign & Engraving. Please contact us through one of the methods indicated below, and we will get back to you as soon as possible.
---
    ...
    <main class="overflow-hidden pb-20">
            ...
            <div class="py-24">
                <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
                    ...
                    <p class="mt-6 text-xl text-warm-gray-500 max-w-3xl">
                        Thank you for your interest in Modern Sign & Engraving. Please contact us through one of the
                        methods indicated below, and we will get back to you as soon as possible.
                    </p>
                </div>
            </div>
        </div>
        ...
        <section class="relative bg-white" aria-labelledby="contact-heading">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="relative bg-white shadow-xl lg:rounded-lg">
                    <h2 id="contact-heading" class="sr-only">Contact us</h2>

                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        <!-- Contact information -->
                        <div
                                class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-primary-500 to-primary-600 sm:px-10 xl:p-12 lg:rounded-lg lg:-m-3">
                            ...
                            <p class="mt-6 text-base max-w-3xl text-gray-50">
                                It is useful to include as much information as possible like size, amounts, colors and
                                planned use.
                            </p>
                            ...
                            <dl class="mt-8 space-y-6">
                                ...
                                <dd class="flex text-base text-gray-50">
                                    <svg class="flex-shrink-0 w-6 h-6 text-gray-50"
                                    ...
                                    <a href="tel:+1-416-668-0144" class="ml-3">+1 (416) 668-0144</a>
                                </dd>
                                ...
                                <dd class="flex text-base text-gray-50">
                                    <svg class="flex-shrink-0 w-6 h-6 text-gray-50"
                                         x-description="Heroicon name: outline/location"
                                         xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke="currentColor"
                                         aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <textarea id="message" name="message" rows="4" required
                              ...
                              aria-describedby="message-max"></textarea>
                                ...
                                <div class="sm:col-span-2 sm:flex sm:justify-end">
                                    <button type="submit"
                                            class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary-500 hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:w-auto">
                                        Submit
                                    </button>
                                </div>
                            </form>
