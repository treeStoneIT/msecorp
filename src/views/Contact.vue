      ...
      <div class="py-24">
        <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
          ...
          <p class="mt-6 text-xl text-warm-gray-500 max-w-3xl">
            Thank you for your interest in Modern Sign & Engraving. Please contact us through one of the methods indicated below, and we will get back to you as soon as possible.
          </p>
        </div>
      </div>
    </div>
        ...
        <div class="relative bg-white shadow-xl lg:rounded-lg">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div
              ...
              <p class="mt-6 text-base max-w-3xl text-gray-100">
                It is useful to include as much information as possible like size, amounts, colors and planned use.
              </p>

              <dl class="mt-8 space-y-6">
                <dt><span class="sr-only">Phone number</span></dt>
                <dd class="flex text-base text-gray-100">
                  <svg class="flex-shrink-0 w-6 h-6 text-gray-50" x-description="Heroicon name: outline/phone"
                ...
                <dd class="flex text-base text-gray-100">
                  <svg class="flex-shrink-0 w-6 h-6 text-gray-50" x-description="Heroicon name: outline/mail"
                       xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                       aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <dd class="flex text-base text-gray-100">
                  <svg class="flex-shrink-0 w-6 h-6 text-gray-50" x-description="Heroicon name: outline/location"
                       xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                       aria-hidden="true">
