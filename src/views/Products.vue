    ...
    <div class="bg-warm-gray-50">
      <div class="max-w-2xl mx-auto py-20 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="mt-4 text-gray-500">Our customizable options can be the ideal solution for your company's signs.
            From shape, size, and color you can customize the signs so it's perfectly suited for the messages you need
            to relay. Lamacoids can clearly communicate information for anything in your facility from identification
            tags, electrical panels, legend plates, machine panels, cable tags, warning signs, valve tags, nameplates
            and more.</p>
        </div>

        <div class="mt-16 space-y-16">
          <div v-for="(feature, productIdx) in products" :key="feature.name"
               class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-x-8 lg:items-center">
            <div
                :class="[productIdx % 2 === 0 ? 'lg:col-start-1' : 'lg:col-start-8 xl:col-start-9', 'mt-6 lg:mt-0 lg:row-start-1 lg:col-span-5 xl:col-span-4']">
              <h3 class="text-lg font-medium text-gray-900">{{ feature.name }}</h3>
              <p class="mt-2 text-sm text-gray-500" v-html="feature.description"></p>
            </div>
            <div
                :class="[productIdx % 2 === 0 ? 'lg:col-start-6 xl:col-start-5' : 'lg:col-start-1', 'flex-auto lg:row-start-1 lg:col-span-7 xl:col-span-8']">
